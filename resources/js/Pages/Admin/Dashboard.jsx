...
export default function Dashboard(props) {
  ...
  // Jika tidak ada data dari backend, tampilkan array kosong atau placeholder
  const displayCompetencyData = (competencyData && competencyData.length > 0) 
    ? competencyData 
    : [
        { name: 'No Data', value: 100 } // Placeholder jika kosong
      ]; 
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 overflow-hidden font-sans transition-colors">
      ...
      <Sidebar lang={lang} currentView={currentView} onSetView={setCurrentView} pendingCount={localPendingCount} />
