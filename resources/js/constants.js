...
export const INITIAL_JOBS = [
  {
    ...
    description: 'Kami mencari mahasiswa tingkat akhir yang bersemangat dalam pengembangan web frontend menggunakan React.js dan Tailwind CSS.',
  ...
  },
  {
    ...
    description: 'Menganalisis data bisnis untuk memberikan wawasan strategis.',
  ...
  },
  {
    ...
    type: 'Contract',
    salary: 'Negotiable',
    description: 'Mencari desainer berbakat untuk proyek aplikasi mobile e-commerce.',
    requirements: ['Portofolio desain yang kuat', 'Menguasai Figma', 'User Centered Design', 'Bisa bekerja dalam tim'],
    status: 'closed',
    postedAt: '2025-12-10',
  ...
  },
  {
    ...
    description: 'Bergabung dengan tim backend kami untuk membangun sistem pembayaran.',
    requirements: ['Pengalaman dengan Go/Java', 'Paham Microservices', 'Database PostgreSQL'],
    status: 'draft',
    postedAt: '2026-02-01',
...
export const COMPETENCY_CHART_DATA = [
